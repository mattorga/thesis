from PyQt5.QtWidgets import (
    ...
    QListWidget, QListWidgetItem, QFileDialog, QMessageBox, QTabWidget, QToolTip,
    QLabel, QGridLayout, QComboBox, QRadioButton, QLineEdit, QGroupBox, 
    QScrollArea, QFrame, QCheckBox, QDoubleSpinBox, QButtonGroup, 
    QStackedWidget, QTableWidget, QSpinBox
)
...
class ConverterCalculatorApp(QWidget):
    def __init__(self, parent=None):
        ...
        # Initialize the UI setup for the ConverterCalculatorApp here
        # In this section, initialize any variables or setups necessary.
        # -------------------------------------------------------------------
        # For example, you might want to include initializations like:
...
class ConfigEditor(QDialog):
    def __init__(self, file_path=''):
        ...
        self.initUI()
        self.processingTab = ConverterCalculatorApp(self)
        #self.tabWidget.addTab(self.processingTab, "Processing")
    ...
    def initUI(self):
        ...
        # Tabs
        self.tabs = QTabWidget(self)  # Use self.tabs as the main tab widget
        project_tab = QWidget()
        processing_tab = ConverterCalculatorApp(self)  # Instantiate the ConverterCalculatorApp here
        opensim_tab = QWidget()

        self.tabs.addTab(project_tab, "Project")
        self.tabs.addTab(processing_tab, "Processing")  # Add ConverterCalculatorApp to the tabs

...
"")
        ...
        self.SimWidget = QtWidgets.QWidget(self.simulationPage)
        self.SimWidget.setGeometry(QtCore.QRect(10, 50, 500, 291))
        self.SimWidget.setAutoFillBackground(False)
        self.SimWidget.setStyleSheet("")
        self.SimWidget.setObjectName("SimWidget")
        self.label = QtWidgets.QLabel(self.SimWidget)
        ...
        self.trialChart.setGeometry(QtCore.QRect(10, 350, 1020, 251))
        self.trialChart.setObjectName("trialChart")
        self.label_2 = QtWidgets.QLabel(self.trialChart)
        ...
        self.baseTrialTable.setGeometry(QtCore.QRect(10, 100, 256, 192))
        ...
        self.versusTrialTable.setGeometry(QtCore.QRect(10, 390, 256, 192))
        ...
        self.baseTrialChart.setGeometry(QtCore.QRect(290, 100, 741, 191))
        self.baseTrialChart.setObjectName("baseTrialChart")
        self.label_3 = QtWidgets.QLabel(self.baseTrialChart)
        self.label_3.setGeometry(QtCore.QRect(360, 90, 71, 16))
        self.label_3.setObjectName("label_3")
        self.versusTrialChart = QtWidgets.QWidget(self.analyticsPage)
        self.versusTrialChart.setGeometry(QtCore.QRect(290, 390, 741, 191))
        self.versusTrialChart.setObjectName("versusTrialChart")
        self.label_4 = QtWidgets.QLabel(self.versusTrialChart)
        self.label_4.setGeometry(QtCore.QRect(360, 90, 71, 16))
        self.label_4.setObjectName("label_4")
        self.comparativeSlider = QtWidgets.QSlider(self.analyticsPage)
        self.comparativeSlider.setGeometry(QtCore.QRect(10, 670, 1021, 22))
        ...
        self.baseGSLabel.setGeometry(QtCore.QRect(290, 300, 90, 39))
        self.baseGSLabel.setObjectName("baseGSLabel")
        self.versusGSLabel = QtWidgets.QLabel(self.analyticsPage)
        self.versusGSLabel.setGeometry(QtCore.QRect(290, 590, 90, 39))
        ...
        self.versusTrialValue.setGeometry(QtCore.QRect(90, 350, 161, 39))
        self.versusTrialValue.setObjectName("versusTrialValue")
        self.baseGPLabel = QtWidgets.QLabel(self.analyticsPage)
        self.baseGPLabel.setGeometry(QtCore.QRect(540, 300, 111, 39))
        self.baseGPLabel.setObjectName("baseGPLabel")
        self.versusGPLabel = QtWidgets.QLabel(self.analyticsPage)
        self.versusGPLabel.setGeometry(QtCore.QRect(540, 590, 111, 39))
        self.versusGPLabel.setObjectName("versusGPLabel")
        ...
        self.newTrialButton = QtWidgets.QPushButton(self.analyticsPage)
        self.newTrialButton.setGeometry(QtCore.QRect(440, 710, 211, 32))
        self.newTrialButton.setObjectName("newTrialButton")
        self.widget = QtWidgets.QWidget(self.analyticsPage)
        self.widget.setGeometry(QtCore.QRect(3, 20, 1031, 32))
        self.widget.setObjectName("widget")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.comparativeAllButton = QtWidgets.QPushButton(self.widget)
        self.comparativeAllButton.setObjectName("comparativeAllButton")
        self.horizontalLayout_5.addWidget(self.comparativeAllButton)
        self.comparativeHipButton = QtWidgets.QPushButton(self.widget)
        ...
        self.comparativeKneeButton = QtWidgets.QPushButton(self.widget)
        ...
        self.comparativeAnkleButton = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "PyQtChart"))
        self.label_4.setText(_translate("MainWindow", "PyQtChart"))
        self.baseGSLabel.setText(_translate("MainWindow", "Gait Stage (°): "))
        self.versusGSLabel.setText(_translate("MainWindow", "Gait Stage (°): "))
        self.baseTrialValue.setText(_translate("MainWindow", "T01_lurch"))
        self.versusTrialValue.setText(_translate("MainWindow", "T00_Normal"))
        self.baseGPLabel.setText(_translate("MainWindow", "Gait Parameters:"))
        self.versusGPLabel.setText(_translate("MainWindow", "Gait Parameters:"))
        self.baseTrialLabel.setText(_translate("MainWindow", "Base Trial:"))
        self.baseTrialLabel_2.setText(_translate("MainWindow", "Versus:"))
        self.newTrialButton.setText(_translate("MainWindow", "Choose a New Trial"))

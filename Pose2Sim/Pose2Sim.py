...
def calibration(config=None, session_dir=None):
    '''
    ...
    # Change 1 (April 29, 2024)
    # Added: If statement, new paramater: session_dir
    # For: Pose2Sim processes within the folder that called the function, not where the target directory is
    if session_dir == None:
        try:
